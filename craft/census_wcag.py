...
CENSUS: dict[str, tuple[str, str, str]] = {
    ...
    "1.2.1": ("Audio-only and Video-only (Prerecorded)", "vocab",
              "the `media` kind: temporal media and alternatives are unsayable"),
    "1.2.2": ("Captions (Prerecorded)", "vocab", "same missing `media` facts"),
    "1.2.3": ("Audio Description or Media Alternative", "vocab", "same"),
    "1.2.4": ("Captions (Live)", "vocab", "same"),
    "1.2.5": ("Audio Description (Prerecorded)", "vocab", "same"),
    "1.2.6": ("Sign Language (Prerecorded)", "vocab", "same"),
    "1.2.7": ("Extended Audio Description", "vocab", "same"),
    "1.2.8": ("Media Alternative (Prerecorded)", "vocab", "same"),
    "1.2.9": ("Audio-only (Live)", "vocab", "same"),
    ...
    "1.4.2": ("Audio Control", "vocab",
              "needs the `autoplay` fact; then compiles"),
    ...
    "1.4.7": ("Low or No Background Audio", "vocab", "the `media` kind again"),
    ...
    "1.4.13": ("Content on Hover or Focus", "vocab",
               "needs the `reveals` fact: dismissable, hoverable, persistent"),
    "2.1.1": ("Keyboard", "zero",
    ...
    "2.5.3": ("Label in Name", "zero",
              ...
              "DOM"),
    "2.5.4": ("Motion Actuation", "vocab",
              "no fact says an act listens to the accelerometer"),
