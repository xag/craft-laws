...
' hides the console that uv's venv pythonw -- a console-subsystem trampoline -- would
' otherwise drag onto the screen for the user to close, killing the icon.
...
sh.Run """" & fso.BuildPath(root, ".venv\Scripts\craft-account-tray.exe") & """", 0, False
